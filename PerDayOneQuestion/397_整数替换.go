...
func integerReplacement(n int) (ans int) {
	...
	_integerReplacement = func(n int) (res int) {
		...
		return 2 + min397(_integerReplacement(n/2), _integerReplacement(n/2+1))
	}
	...
	//}
	//return 2 + min397(integerReplacement(n/2), integerReplacement(n/2+1))
